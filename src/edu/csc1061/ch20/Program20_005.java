...
public class Program20_005 extends Application {
  ...
  private class MultipleBallPane extends Pane {
    ...
    public MultipleBallPane() {
      ...
      animation =
        new Timeline(new KeyFrame(Duration.millis(50), e -> moveBall()));
    ...
    public void subtract() {
      // (getChildren().size() > 0) // original if statement way to do this.
