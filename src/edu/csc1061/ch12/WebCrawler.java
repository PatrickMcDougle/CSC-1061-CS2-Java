...
public class WebCrawler {
    ...
    private ArrayList<String> readLineForUrls(String line) {
        ...
        while (startOfUrlIndex >= 0) {
            ...
            // Ensure that a correct URL is found, i.e. there is an end to the URL string and its
            // after
            ...
            if (endOfUrlIndex > startOfUrlIndex) {
                ...
                // Not sure why we didn't find an end of the URL, so just assume bad webpage
                // development
                // and move on.
                startOfUrlIndex = -1;
            }
    ...
    private boolean shouldWeUseThisUrl(String checkUrl) {
        return checkUrl.indexOf(".png") == -1 // ignore images
                && checkUrl.indexOf(".gif") == -1 && checkUrl.indexOf(".jpg") == -1
                && checkUrl.indexOf(".jpeg") == -1 && checkUrl.indexOf(".webp") == -1
                && checkUrl.indexOf(".svg") == -1 && checkUrl.indexOf(".mp4") == -1 // ignore video
